...
public class EngineParams extends org.apache.avro.specific.SpecificRecordBase
   ...
   */
  public static org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder
      newBuilder() {
    return new org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder();
  }
  ...
  public static org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder
      newBuilder(
          org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder other) {
    if (other == null) {
      return new org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder();
    } else {
      return new org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder(
   ...
   */
  public static org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder
      newBuilder(org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams other) {
    if (other == null) {
      return new org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder();
    } else {
      return new org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder(
  ...
  public static class Builder
     ...
     */
    private Builder(
        org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.defaultContainer)) {
        this.defaultContainer = data().deepCopy(fields()[0].schema(), other.defaultContainer);
     ...
     */
    public org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder
        setLaunchDir(java.lang.String value) {
     ...
     */
    public org.icgc.argo.workflow_management_scheduler.rabbitmq.schema.EngineParams.Builder
        setResume(java.lang.String value) {
